<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	<div class="navbar-nav">
		<a class="nav-item nav-link nav-pills-estilo" href="{{url('/administrador/categorias')}}">Categorias</a>
		<a class="nav-item nav-link nav-pills-estilo" href="{{url('/administrador/servicios')}}">Servicios</a>
