@extends('layouts.app')
@section('titulo','Modificar una Region')
				...
				<div class="col-12 col-sm-6 col-md-6">
					...
					<div class="card margin-arriba margin-abajo card-raised">						
						<div class="card-header text-center">
							<h4 class="card-title">Modificar la {{$region->region}}</h4>
						</div>
						<div class="card-body">
							<form action="{{url('/administrador/regiones/'.$region->id.'/edit')}}" method="POST" enctype="multipart/form-data">
								{{csrf_field()}}
								<div class="form-group">
									<div class="input-group">
										<span class="input-group-addon"><i class="material-icons">work</i></span>
										<input type="text" class="form-control" name="region" placeholder="Region" value="{{old('region',$region->region)}}">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<a href="{{url('/administrador/regiones')}}" class="btn btn-secondary btn-sm pull-right">Cancelar</a>
