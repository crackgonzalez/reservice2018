@extends('layouts.app')
@section('titulo','Modificar una Comuna')
				...
				<div class="col-12 col-sm-6 col-md-6">
					...
					<div class="card margin-arriba margin-abajo card-raised">						
						<div class="card-header text-center">
							<h4 class="card-title">Modificar la Comuna de {{$comuna->commune}}</h4>
						</div>
						<div class="card-body">
							<form action="{{url('/administrador/comunas/'.$comuna->id.'/edit')}}" method="POST" enctype="multipart/form-data">
								{{csrf_field()}}
								<div class="form-group">
									<div class="input-group">
										<span class="input-group-addon"><i class="material-icons">work</i></span>
										<input type="text" class="form-control" name="commune" placeholder="Comuna" value="{{old('commune',$comuna->commune)}}">
									</div>
								</div>
								<div class="form-group">
                                    <div class="input-group">
