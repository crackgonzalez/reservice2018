...
@extends('layouts.app')
@section('titulo','Confirmar Presupuesto')
			...
			@endif
				<div class="card margin-arriba margin-abajo card-raised">						
					<div class="card-header text-center">
						<h4 class="card-title">Confirmar el Presupuesto a {{$respuesta->empresa->usuario->name}}</h4>
					</div>
					<div class="card-body">
						<form action="{{url('/cliente/presupuesto/'.$respuesta->id.'/confirmacion')}}" method="POST" enctype="multipart/form-data">
						{{csrf_field()}}
